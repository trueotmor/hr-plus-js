...
$_lang['setting_zoomx_parse_json_to_post'] = 'Парсить JSON';
$_lang['setting_zoomx_parse_json_to_post_desc'] = 'Создать массив $_POST для JSON запроса (только для POST метода).';
